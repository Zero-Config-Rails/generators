# Auto-generated from `rails generate resource --help` via `rake rails_generate:parse[resource]`
# Generated on: 2026-06-10 10:18:06 UTC

module RailsGenerators::Generated::ResourceConfigurationsHelper
  include RailsGenerators::ConfigurationSupport

  def resource_generator_required_configurations
    [
  ...
  def resource_generator_optional_configurations
    [
      ConfigurationStruct.new(
      ...
      ConfigurationStruct.new(
        ...
        label: nil,
        description:
          "ModelName to be used -c, --resource-controller=NAME # Resource controller to be invoked #",
        is_required: false,
        fieldable_name: "text_field",
        fieldable:
          FieldStruct.new(type: "text_field", default_value: "controller"),
        should_hide_configuration_name: false,
      ...
      ConfigurationStruct.new(
        ...
        label: nil,
        description:
          "Actions for the resource controller --resource-route # Indicates when to generate resource route #",
        is_required: false,
        fieldable_name: "boolean_field",
